...
for ne in [300]: #number of sfcs
    for nv in [2, 3, 4, 5]:
        for count in range(0, 10):
            ...
            # print cpu_rate
            # print bw_rate
            output_results_csv(str(failed_count), './results/NSFNET/resource_constraints/' + str(ne) + '-' + str(nv) + '-results-failed-count.csv')
            output_results_csv(str(cpu_rate), './results/NSFNET/resource_constraints/' + str(ne) + '-' + str(nv) + '-results-cpu-rate.csv')
            output_results_csv(str(bw_rate), './results/NSFNET/resource_constraints/' + str(ne) + '-' + str(nv) + '-results-bw-rate.csv')
