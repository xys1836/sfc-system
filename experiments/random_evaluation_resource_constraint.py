...
for ne in [100, 200, 300, 400, 500]:
    for nv in [2, 3, 4, 5]:
        for count in range(0, 10):
            ...
            output_results_csv(str(failed_count), './results/random/100/005/resource_constraints/' + str(ne) + '-' + str(nv) + '-results-failed-count.csv')
            output_results_csv(str(cpu_rate), './results/random/100/005/resource_constraints/' + str(ne) + '-' + str(nv) + '-results-cpu-rate.csv')
            output_results_csv(str(bw_rate), './results/random/100/005/resource_constraints/' + str(ne) + '-' + str(nv) + '-results-bw-rate.csv')
